...
// https://arbiscan.io/address/0x87da6930626fe0c7db8bc15587ec0e410937e5dc#code
...
interface IPostTechProfile {
    ...
    function holderAndReferralFeeDestination() external view returns (address);
    ...
    function setHolderFeeDestination(address _feeDestination) external;

    function setProtocolFeePercent(uint256 _feePercent) external;

    function setSubjectFeePercent(uint256 _feePercent) external;

    function sethHolderFeePercent(uint256 _feePercent) external;

    function sethReferralFeePercent(uint256 _feePercent) external;
